...
photos: >-
  http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/Bigdata-Problems-cover.jpg
...
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HDFS/HDFS-Problems-01.png)  
...
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HDFS/HDFS-Problems-02.png)  
...
重启过程中丢失块数一直在减少：
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HDFS/HDFS-Problems-03.png) 
最终恢复正常
总结：
...
NN日志如下：
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HDFS/HDFS-Problems-04.png) 
...
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HDFS/HDFS-Problems-05.png) 
...
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HDFS/HDFS-Problems-06.png) 
...
3. yarn logs无法正常输出日志
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/Yarn/Yarn-Problems-01.png) 
原因：yarn.nodemanager.remote-app-log-dir要设置为/tmp/logs 不能修改为其他盘
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/Yarn/Yarn-Problems-02.png) 
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/Yarn/Yarn-Problems-03.png) 
...
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-03.png) 
发现表元数据中都没有regionserver的信息，正常情况是这样的：
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-04.png) 
...
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-07.png) 
...
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-05.png) 
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-08.png) 
...
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-06.png) 
从监控上看，宕机后，各RegionServer中的总区域暂时下降五分之一，13:40左右Region总数恢复到原始数量，而读写请求有大量失败，且读写吞吐量很低。
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-09.png)
...
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-11.png)
* 13:22各个节点开始有大量超时的客户端请求。
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-10.png)
客户端开始频繁抛出org.apache.hadoop.hbase.NotServingRegionException
* 13:33:31 其他节点开始打开hbase04下线的Region
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-12.png)
由于HBase服务端Region无法提供服务，导致客户端出现请求队列积压：
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-13.png)
...
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-14.png)
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-15.png)
```error
...
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-16.jpg)
而以上报错“The new max sequence id 1 is less than the old max sequence id 2380665”，newMaxSeqId = 1L
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-17.png)
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-18.png)
根据日志 报错主要发生在OpenRegion的过程，证明initializeRegionInternals方法运行异常，nextSeqId = -1
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-19.png)
继续追溯ERROR： Could not initialize all stores for the region=xxx,xxx,xxx.76c8f8961f500e02029cf3d731b8cdb5.
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-20.png)
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-21.png)
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-22.png)
继续追溯getMaxSequenceId方法
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-23.png)
...
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-24.png)
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-25.png)
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-26.png)
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-27.png)
...
所以archive目录只有单副本。
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-28.png)
...
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-33.png)
机器启动  其他节点关闭Region
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-29.png)
RS平均Region数下降
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-30.png)
宕机恢复的节点，Region初始化正常
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-31.png)
过一会儿在宕机恢复的节点Region Open成功，Region均匀分配过来
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-32.png)

3. 集群新增RS致另一RS异常退出
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-01.png) 
上线的RegionServer会触发Region移动，报错前有Flush操作，因为Region移动前会先Flush Region
异常相关源码：
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/HBase/HBase-Problems-02.png)  
...
![alt](http://imgs.shmily-qjj.top/BlogImages/Bigdata-Problems/Kafka/Kafka-Problems-01.png) 
