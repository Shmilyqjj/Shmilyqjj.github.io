...
photos: >-
  https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-intro.jpg
abbrlink: 38328
...
## CDH架构
![alt CDH-01](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-01.jpg) 
CDH的组件：
...
* 使用VMWare
 采用NAT格式网卡,按如下配置  
 虚拟网卡设置（编辑-虚拟网络编辑器）  
 ![alt CDH-02](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-02.jpg)  
 点击NAT设置:  
 ![alt CDH-2.5](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-02.5.jpg) 
 点击DHCP设置:  
 ![alt CDH-03](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-03.jpg)  
 以后我们的虚拟机都使用NAT网卡  
 **安装CentOS7**  
 ...
 ![alt CDH-03.5](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-03.5.jpg)  
 关闭->完成->开启此虚拟机 
 开始安装  
 ![alt CDH-04](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-04.jpg)  
 安装Minimal版的CentOS，感觉很清爽！但是后续需要自己手动装一些依赖包，不过这样也好，可以避免安装过多无用的依赖。时区选择ShangHai。  

 此步骤时指定root密码123456  
 安装时指定一个管理员用户shmily 密码123456  
 ![alt CDH-05](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-05.jpg)  
 ![alt CDH-05.5](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-05.5.jpg)  
...
* 使用Hyper-V（推荐）
 ...
 ........
 我的设置如图：
 ![alt CDH-05.6](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-05.6.JPG)  
 ![alt CDH-05.7](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-05.7.JPG)  
 ![alt CDH-05.8](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-05.8.JPG)  
 ![alt CDH-05.9](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-05.9.JPG)  
...
重新用SecureCRT连接出现如下图:
![alt CDH-06](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-06.jpg)  
Accept & Save,输入密码并勾选Save password  
完成  
FileZilla也能连接了:  
![alt CDH-07](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-07.jpg)  

检查一下网络:  
ping 8.8.8.8  
能ping通即可进行下一步，如果ping不通，需要仔细检查网络配置文件:  
![alt CDH-08](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-08.jpg)  
...
要明确CDH6.3支持的JDK版本：  
![alt CDH-25](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-25.JPG)  
...
![alt CDH-08.6](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-08.6.jpg)  
如图安装完成，接着我们对其进行一些配置  
```shell
...
如图即为配置成功  
![alt CDH-09](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-09.jpg)  
...
![alt CDH-09.5](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-09.5.jpg)  
...
![alt CDH-09.6](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-09.6.jpg) 

Mysql JDBC库配置：  
右键 链接另存为 进行下载  
**[下载mysql-connector-java-5.1.47-bin.jar](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/mysql-connector-java-5.1.47-bin.jar)**，将mysql-connector-java-5.1.47-bin.jar文件上传到CDH066节点上的/usr/share/java/目录下并重命名为mysql-connector-java.jar（如果/usr/share/java/目录不存在，需要手动创建）  
...
```  
![alt CDH-10](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-10.jpg)  
...
```
![alt CDH-11](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-11.jpg)  
...
修改后如图  
![alt CDH-12](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-12.jpg)  
...
测试都能免密登录:  
![alt CDH-13](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-13.jpg)  
至此免密登录配置完成  
...
我们搭建的本地源，后面会用到  
![alt CDH-14](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-14.jpg)  
...
![alt CDH-15](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-15.jpg)  

等待几分钟后访问**http://cdh066:7180**，默认帐号密码都是**admin**  
![alt CDH-16](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-16.jpg)  

这里选择免费版本
![alt CDH-17](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-17.jpg)  

下面就是群集安装的步骤：  
主机名称填写cdh066,cdh067,cdh068,cdh069，然后点击搜索搜索
![alt CDH-18](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-18.JPG)  
...
![alt CDH-19](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-19.JPG)  
若继续按钮仍为灰色，可以点击更多选项，将所有外部源的链接全部删掉，增加本地parcel源地址，保存更改。

这步**不要勾选**
![alt CDH-20](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-20.JPG)  

填入root用户的密码  
![alt CDH-21](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-21.JPG)  

这步耐心等待，**不要手动刷新**  
![alt CDH-22](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-22.JPG)  

![alt CDH-22.25](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-22.25.JPG)  

这步勾选最后一项  
![alt CDH-22.3](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-22.3.JPG)  
企业安装时，最好先Inspect Hosts，验证节点是否有配置不当的地方，避免影响稳定性。针对Inspect Hosts的结果，可以一条一条优化集群配置。

开始安装服务 如图，选**自定义服务**  
根据集群环境和需求选择合适的服务和搭配。  
![alt CDH-22.4](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-22.4.JPG)  
![alt CDH-22.5](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-22.5.JPG)   

填上之前建的数据库，选的服务不同要求也不同  
![alt CDH-22.6](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-22.6.JPG)  

最后部署成功，启动服务：  
因为我虚拟机搭建，物理机本身配置就很差，有内存不足和请求延迟高的问题，所以，虽然服务都能正常打开，跑一两个小的计算任务也还能勉强承受，但CDH都会报警告，大多都是提示分配内存低了，请求延迟高了，内存不足等信息。  
![alt CDH-24](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-24.JPG)  
后续文章更新内容采用新电脑64GB内存i7-9750h物理机环境，能正常运行CDH服务：
![alt CDH-31](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-31.JPG)  
...
![alt CDH-27](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-27.JPG)  
![alt CDH-26](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-26.JPG)  
完成分配后开始添加服务：
![alt CDH-28](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-28.JPG)  
![alt CDH-29](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-29.JPG)  
![alt CDH-30](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-30.JPG)  
...
![alt CDH-32](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-32.JPG)  
![alt](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-33.JPG)  
打开控制面板->查看网络连接->找到Cluster 设置IP和DNS
![alt](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-34.JPG)  
设置外网共享 让虚拟机可以连接外部网络
![alt](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-35.JPG)
重新回到上一步设置IP和DNS
![alt](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-34.JPG)  
修改虚拟机设置网络设置
![alt](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-36.JPG)
停止所有cloudera服务
```shell
...
![alt](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-37.JPG)
...
## Cloudera Manager使用
![alt CDH-usage-01](https://blog-images-1257889704.cos.ap-chengdu.myqcloud.com/BlogImages/CDH/CDH-usage-01.JPG)  
