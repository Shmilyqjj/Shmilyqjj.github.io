...
photos: >-
  https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/Manjaro-Cover.png
abbrlink: 3f34ebe3
...
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-01.JPG)  
双显卡用户注意事项(单显卡忽略此步骤)：
Nvidia+Intel双显卡笔记本安装需要这步：安装前给内核传参=>按e在quiet后加：acpi_osi=! acpi_osi="Windows 2009"  按F10启动，否则会卡死无法进入桌面
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-02.JPG)  
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-03.JPG) 

双击 Install Manjaro Linux打开安装向导
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-01.png)  
时区选择Asia/ShangHai
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-02.png) 
键盘默认即可
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-03.png)
接下来是关键步骤 磁盘要选手动分区 
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-04.png) 
磁盘空间规划：
...
在空闲区域创建分区 步骤如下：
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-05.png)
数据分区最终结果如下：
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-06.png)
启动分区(EFI分区) 如下设置：
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-07.png)
最后设置系统管理员用户
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-08.png)
安装完成后 可以重启
...
```
软件商店勾选启用AUR和Snap源
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-09.png)
...
配置输入法：
将拼音上移，作为默认输入法
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-10.png)
设置shift按键为切换中英文输入的按键
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-11.png)
根据个人习惯 设置共享输入状态 (我一般不设置) 
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-12.png)
更换输入法主题:
```shell
...
启用云拼音
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-42.png)
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-43.png)
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-44.png)
...
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-13.png)

只浏览网页推荐使用Chrome浏览器插件Proxy SwitchyOmega:
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-14.png)
**必要时可以使用系统全局代理**：
进入系统设置->网络设置->使用系统代理服务器配置(或使用手动设置的代理服务器)->http代理设为127.0.0.1:7890 Socks代理设置为127.0.0.1:7891
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-15.png)
**配置Clash开机自启**：
```shell
...
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-16.png) 
...
安装后重启一到两次即可完成安装
应用商城
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-38.png) 
已安装应用
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-39.png) 
使用Android APP
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-40.png) 
...
根据偏好设置latte dock
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-17.png) 
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-18.png) 
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-19.png) 
效果
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-20.png) 

### oh-my-zsh
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-21.png) 
```shell
...
|   |   |
| ---- | ---- |
| <img src="https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-22.png" width=100% style="border:solid 3px #CCFFFF" title="Konsole配置" align=left alt="Konsole配置"> | <img src="https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-23.png" width=100% style="border:solid 3px #CCFFFF" title="Konsole配置" align=right alt="Konsole配置"> |
| <img src="https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-24.png" width=100% style="border:solid 3px #CCFFFF" title="Konsole配置" align=left alt="Konsole配置"> | <img src="https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-25.png" width=100% style="border:solid 3px #CCFFFF" title="Konsole配置" align=right alt="Konsole配置"> |
| <img src="https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-26.png" width=100% style="border:solid 3px #CCFFFF" title="Konsole配置" align=left alt="Konsole配置"> | <img src="https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-27.png" width=100% style="border:solid 3px #CCFFFF" title="Konsole配置" align=right alt="Konsole配置"> |


### 全局主题
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-Desktop.png) 

打开设置->外观->全局主题
之所以喜欢用Mac的全局主题（McSur-dark）是因为它的任务栏比较好看比较精致
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-28.png) 

### 窗口
窗口选择了这款，按钮比较简洁，是和Mac相近的，但按钮位置在右边，我还是比较习惯这种按键位置。点击主题上的按钮可以调节主题按键大小，下方可以调节窗口边框大小
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-29.png) 
窗口配色方案我选的Ambiance-ISH，亮色看起来更敞亮，心情更好。
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-30.png) 

### 登陆页
登陆页面只有每次开机时才会出现，锁屏是单独的锁屏页面。
打开设置->开机与关机->登录屏幕(SDDM) 在这里设置
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-33.png) 
效果：
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-32.png) 

### 欢迎屏幕
开机在登陆页面输入密码后会进入欢迎屏幕，大概有2秒左右停留在欢迎屏幕，随便选个好看的就可以了。
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-31.png) 

### 锁屏界面
每次锁屏(Meta+L)后都会显示这个页面。
打开设置->工作区行为->锁屏->外观：配置
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-34.png) 

### 桌面特效
这里会有一些神奇的界面效果，如窗口惯性拖动，最小化神灯效果，窗口切换效果等。
打开设置->工作区行为->桌面特效
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-35.png) 
...
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-41.png) 
...
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-36.png) 
...
![alt ](https://gitee.com/shmilyqjj/BlogImages/raw/master/cdn_sources/Manjaro/ManjaroInstall-37.png) 
